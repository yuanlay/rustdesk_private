...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "LHX2048".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.205.20"];
pub const RS_PUB_KEY: &str = "MEtxSNHX8qhp6lT4rQicHJSZdilAOq8YQnSg1JqSwvQ=";
